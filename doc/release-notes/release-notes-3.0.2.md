WORM Core version 3.0.2 is now available from:
...
WORM Core v3.0.2 is a recommended, semi-mandatory update for all users. This release contains transaction creation bug fixes for zWORM spends, automint calculation adjustments, and other various updates/fixes.
...
- #282 `310f216` [Wallet] Count pending zWorm balance for automint. (presstab)
