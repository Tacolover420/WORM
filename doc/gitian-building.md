...
git clone https://github.com/worm-crypto/worm.git
cd worm
...
```bash
    ...
    From https://github.com/worm-crypto/worm
...
[worm/gitian.sigs](https://github.com/worm-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
