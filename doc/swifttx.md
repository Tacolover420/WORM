...
* API: [https://github.com/WORM-Project/insight-api-worm#swifttx-transactions](https://github.com/WORM-Project/insight-api-worm#swifttx-transactions) 
...
By default, the WORM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the WORM Core daemon:
