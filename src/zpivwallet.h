...
#ifndef WORM_ZWORMWALLET_H
#define WORM_ZWORMWALLET_H
...
public:
    CzWORMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZWORM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZWORM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
