...
extern UniValue setzwormseed(const UniValue& params, bool fHelp);
extern UniValue getzwormseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzworm(const UniValue& params, bool fHelp);
extern UniValue dzwormstate(const UniValue& params, bool fHelp);
