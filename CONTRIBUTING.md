Contributing to WORM Core
============================

The WORM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the WORM Core project, and is not to be
confused with overall WORM Network Protocol consensus changes.

Whether a pull request is merged into WORM Core rests with the project merge
...
The project leader is the release manager for each WORM Core release.
